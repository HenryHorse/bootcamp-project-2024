...
function appendBlog(container_id) {
    const blogContainer = document.getElementById(container_id);
    blogContainer === null || blogContainer === void 0 ? void 0 : blogContainer.classList.add("grid", "grid-cols-1", "gap-8", "md:grid-cols-2", "lg:grid-cols-3", "p-6");
    blogs.sort((a, b) => {
